...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                <a class="nav-link  " href="<?= $baseUrl ?>pages/cadastrarFuncionario.php">Cadastrar Funcionario</a>
            </li>
        </ul>
    </div>
    <i class="far fa-user p-2 font-family-base" style="color: #000; font-size: 1.25rem; "><a style="font-family: Arial"> <?= $_SESSION['usuario']?></a> </i>
